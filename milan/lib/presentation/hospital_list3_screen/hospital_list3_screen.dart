...
class HospitalList3Screen extends GetWidget<HospitalList3Controller> {
  @override
                                                                      ...
                                                                      children: [
                                                                        Container(
                                                                            ...
                                                                            decoration: AppDecoration
                                                                                .textStyleSourceSerifProsemibold303,
                                                                            child: Text("lbl_messaging".tr,
                                                                                textAlign: TextAlign.center,
                                                                                style: AppStyle.textStyleSourceSerifProsemibold303.copyWith(fontSize: getFontSize(30)))),
                                                                        Padding(
                                                                            padding:
                                                                                EdgeInsets.only(top: getVerticalSize(90.00)),
                                                                            child: Container(alignment: Alignment.center, height: getVerticalSize(91.00), width: getHorizontalSize(264.00), decoration: AppDecoration.textStyleSourceSerifProsemibold303, child: Text("lbl_voice_call".tr, textAlign: TextAlign.center, style: AppStyle.textStyleSourceSerifProsemibold303.copyWith(fontSize: getFontSize(30)))))
                                                                      ]))),
                                                          Align(
                                                              alignment:
                                                                  Alignment
  ...
  onTapBtnPrevious() {
    Get.toNamed(AppRoutes.hospitalList1Screen);
  }
}
